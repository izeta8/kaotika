  ...
  return (  
    ...
    >
      <Layout>
        ...
        <ShopPlayerInfo />
        <ShopContent categoryData = {categoryData} addToCart={addToCart}/>  
        <Background />
...
const ShopContent = ({categoryData,addToCart}) => {
  ...
  return (
    <section className='w-full h-full relative z-30 flex justify-center items-center'>    
      ...
      {/* FILTER AND SORT BY */}
      <ItemsList categoryData = {categoryData} addToCart={addToCart}/>
...
const ItemsList = ({categoryData,addToCart}) => {
  return (
