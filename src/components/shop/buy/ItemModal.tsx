...
const ItemModal: React.FC<{itemModalShown: boolean, setItemModalShown: Function, itemData: ItemData | undefined, playerData: any, isMagicalStuffShop: boolean}> = ({itemModalShown, setItemModalShown, itemData, playerData, isMagicalStuffShop}) => {
  ...
  const modalBackgroundImage = isMagicalStuffShop ? "url('/images/shop/buy/magical_stuff_modal_background.webp')" : "url('/images/shop/buy/equipment_modal_background.webp')";
